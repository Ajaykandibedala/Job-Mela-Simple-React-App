...
<button onClick={()=>setPage((prev) => prev + 1)}  className="border-[2px] rounded-[10px] block p-[10px] w-full text-[14px] font-semibold text-textColor hover:bg-blue group-hover/item:text-textColor group-hover:black">
  Load More..
  </button>
